  ...
  return (
    <a href='https://whatsapp.com/channel/0029VbAv0QeGOj9rVz73Ci2g' target='_blank' className='w-full'>
      <div className='bg-green-500'>
        <div className='flex flex-col flex-wrap items-center justify-between max-w-5xl gap-0 p-4 mx-auto text-white md:gap-4 font-inter lg:flex-row'>
          <div className='max-w-full text-lg leading-relaxed text-center sm:text-xl md:text-2xl lg:text-left sm:max-w-3/4'>
          ...
          <div className='hidden md:flex items-center justify-center px-6 py-3 mt-4 text-base font-bold text-green-600 transition duration-300 ease-in-out transform bg-white rounded-full shadow-md hover:bg-gray-100 sm:text-lg hover:scale-105 sm:mt-0' rel='noopener'>
            <picture>
