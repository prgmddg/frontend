...
export default function VideoSemi (props: { id: number, video: string, titulo: string, fecha: string, hora: string, etiqueta: string }) {
  const { video, titulo, fecha, hora } = props
